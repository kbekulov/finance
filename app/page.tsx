...
const THEMES = [
  { id: "kinance", label: "Kinance", banners: ["/theme-banners/kinance.png?v=8", "/theme-banners/kinance-frame-2.png?v=8"] },
  { id: "kinance-moon", label: "Kinance Moon", banners: ["/theme-banners/kinance.png?v=8", "/theme-banners/kinance-frame-2.png?v=8"] },
